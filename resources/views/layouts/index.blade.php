...
<html lang="en" class="layout-navbar-fixed layout-menu-fixed layout-compact" dir="ltr" data-skin="default"
    data-assets-path="../../assets/" data-template="vertical-menu-template-no-customizer-starter" data-bs-theme="light">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu">
                <div class="app-brand demo">
                    <a href={{ url('/home') }} class="app-brand-link">
                        ...
                        <span class="app-brand-text demo menu-text fw-bold ms-2">Mindseat</span>
                    </a>
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item active">
                        <a href="/home" class="menu-link">
                            ...
                            <div data-i18n="Page 1">Pagina Inicial</div>
                        </a>
                    </li>
                    <li class="menu-item">
